 ...
 * bar-chart.tsx
 * 
 * Componente de gráfico de barras para exibir dados financeiros
...
export interface BarChartProps {
  ...
  /**
   * Se true, as barras serão empilhadas
   */
  stacked?: boolean;
 ...
 * Componente BarChart
 * 
 * Renderiza um gráfico de barras usando Recharts
 * 
 * @param {BarChartProps} props - Propriedades do componente
